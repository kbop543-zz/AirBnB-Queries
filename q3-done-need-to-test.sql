...
-- Violators with non-NULL propertyType listings
/*
...
-- Listing.propertyType should be NULL, all bylaws apply to this listing (both max and min)
...
-- SELECT * FROM MinViolators;
-- SELECT * FROM MaxViolators;
-- SELECT * FROM NullViolators;
SELECT DISTINCT 
	owner as homeowner,
	listingID,
	year,
