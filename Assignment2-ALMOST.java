    ...
    */
    ...
    public ArrayList homeownerRecommendation(int homeownerID) {
        ...
        try{
            ...
            String q6 = "CREATE VIEW ScoreTable AS "+
                        "SELECT R1homeownerid, R2homeownerid, sum(multiplier) as scores "+
                        "FROM rating2 "+
                        "WHERE R1homeownerid = ? "+
            ...
            while(rs2.next()){   
                ...
                //grab values from q6
                int recHomeowners = rs.getInt("R2homeownerid");
                int recHomeownerScore = rs.getInt("scores");
